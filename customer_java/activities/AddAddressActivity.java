...
import static com.example.food_tanya.R.id.add_address_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addAddressBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final_address=userName+" "+userCity+" "+userAddress+" "+userCode+" "+userNumber;
                if ( !userName.isEmpty() && !userCity.isEmpty() && !userAddress.isEmpty() && !userCode.isEmpty() && !userNumber.isEmpty()){
                    ...
                    Toast.makeText(AddAddressActivity.this, "Kindly Fill All the Details", Toast.LENGTH_SHORT).show();
                }
            }
        });
