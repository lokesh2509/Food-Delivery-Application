        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(textFullName)) {
                    ...
                    Toast.makeText(RegistrationActivity.this, "please enter your date of birth", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(RegistrationActivity.this, "please enter mobile number", Toast.LENGTH_LONG).show();
                    editTextRegisterMobile.setError("Mobile number is required");
                    editTextRegisterMobile.requestFocus();
                } else if (textMobile.length() != 10) {
                    Toast.makeText(RegistrationActivity.this, "please re-enter your number", Toast.LENGTH_LONG).show();
                    editTextRegisterMobile.setError(" Valid  number is required");
                    editTextRegisterMobile.requestFocus();

                } else if (!mobileMatcher.find()) {
                    Toast.makeText(RegistrationActivity.this, "Mobile Number is not valid.", Toast.LENGTH_LONG).show();
                    editTextRegisterMobile.requestFocus();
                    ...
                    Toast.makeText(RegistrationActivity.this, " password should not be less then 6 digits", Toast.LENGTH_LONG).show();
